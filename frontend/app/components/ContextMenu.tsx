...
export default function ContextMenu({ show, setShow, children }: { show: boolean; setShow: (e: boolean) => void; children: any }) {
  ...
  return (
    <div ref={menuRef} className={`${show ? "absolute" : "hidden"} top-10 right-0 display`}>
